...
func (_m *PersonServiceClient) UpdatePerson(ctx context.Context, in *example.UpdatePersonRequest, opts ...grpc.CallOption) (*example.Person, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *example.Person
	if rf, ok := ret.Get(0).(func(context.Context, *example.UpdatePersonRequest, ...grpc.CallOption) *example.Person); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*example.Person)
