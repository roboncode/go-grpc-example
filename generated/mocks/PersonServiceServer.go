...
func (_m *PersonServiceServer) UpdatePerson(_a0 context.Context, _a1 *example.UpdatePersonRequest) (*example.Person, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *example.Person
	if rf, ok := ret.Get(0).(func(context.Context, *example.UpdatePersonRequest) *example.Person); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*example.Person)
