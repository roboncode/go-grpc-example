...
// HttpServiceClient is an autogenerated mock type for the HttpServiceClient type
type HttpServiceClient struct {
	mock.Mock
}

// CreatePerson provides a mock function with given fields: ctx, in, opts
func (_m *HttpServiceClient) CreatePerson(ctx context.Context, in *example.CreatePersonRequest, opts ...grpc.CallOption) (*example.Person, error) {
...
func (_m *HttpServiceClient) DeletePerson(ctx context.Context, in *example.DeletePersonRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *HttpServiceClient) GetPerson(ctx context.Context, in *example.GetPersonRequest, opts ...grpc.CallOption) (*example.Person, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *HttpServiceClient) GetPersons(ctx context.Context, in *example.GetPersonsRequest, opts ...grpc.CallOption) (*example.Persons, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *HttpServiceClient) UpdatePerson(ctx context.Context, in *example.UpdatePersonRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
