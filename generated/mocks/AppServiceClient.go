...
func (_m *AppServiceClient) CreatePerson(ctx context.Context, in *example.CreatePersonRequest, opts ...grpc.CallOption) (*example.Person, error) {
...
func (_m *AppServiceClient) DeletePerson(ctx context.Context, in *example.DeletePersonRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *AppServiceClient) GetPerson(ctx context.Context, in *example.GetPersonRequest, opts ...grpc.CallOption) (*example.Person, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *AppServiceClient) GetPersons(ctx context.Context, in *example.GetPersonsRequest, opts ...grpc.CallOption) (*example.Persons, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
...
func (_m *AppServiceClient) UpdatePerson(ctx context.Context, in *example.UpdatePersonRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
